<template>
  <div>
    ...
    <div v-if="compra === 'A'">
      ...
      <div class="row">
        <div class="col">
          <button type="button" class="btn btn-success" v-on:click="menuCompra()">Agregar Compra</button>
        </div>
        <div class="col">
          <p></p>
        </div>
      ...
      <div>
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="item in arrayCompras" :key="item.id">
              <th v-text="item.user_id"></th>
              <th v-text="item.proveedor_id"></th>
    ...
    <!-- compra -->
    <div v-if="compra === 'B'">
      <button type="button" class="btn btn-secondary" v-on:click="menuCompra()">Cancelar</button>
      <button
        type="button"
      ...
      <div class="row">
        ...
        <div class="col">
          <div class="form-row">
            ...
            <div class="form-group col-md-5">
              <label for="inputCity">Cantidad a Comprar</label>
        ...
        <div class="modal-content">
              ...
              <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col">
                        <label for="proveedor">Proveedor</label>
                        <input type="text" class="form-control" v-model="proveedor_id" />
                      </div>
                      <div class="col">
                        <label for="impuesto">Impuesto</label>
                        <input type="number" step="any" class="form-control" v-model="impuesto" />
...
export default {
  ...
  methods: {
    consultarCompras() {
      axios
        .get("/compra?buscar=" + this.valorBuscar)
        .then(response => (this.arrayCompras = response.data));
    },
    ...
    consultarProveedor() {
      axios
        .get("/proveedor")
        .then(response => (this.arrayProveedor = response.data));
    },
    ...
    abrirModalVer(objeto) {
      this.id = objeto.id;
      this.proveedor_id = objeto.proveedor_id;
